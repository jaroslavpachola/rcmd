...
const TEXT: &[&str] = &[
    ...
    "                  after another",
    "  Disk usage mode (F9 > Command, or disk-usage): ncdu's view - every",
    "                  directory sized as you enter it, biggest first,",
    "                  a bar in place of the date; sizes kept for the",
    "                  session; the same entry puts the order back",
    ...
    "  = EXPR          a calculator: = 2*(3+4), = 0x1f+1, = 3G/4K - the",
    "                  answer on the status line and the command line",
    ...
    "  and a click or a drag on its scrollbar moves through the listing.",
    "  viewer, editor, preview or list dialog. In the find, copy/move,",
    "  select, link, options, chmod and chown dialogs a click takes a",
    "  field, ticks a switch or presses a button; a question's Yes and",
    "  No take one too, and a fuzzy-find row (double-click goes there).",
